...
* 활용 예제
  ...
  + 얼굴 객체 탐지
    ...
    - 함수 : **face_recognition.facec_location(<탐지할 미디어>, <모델>)**<br/>
      <br/>
      > **reference_image**: 기준 이미지, 인가 객체 얼굴이 존재하는 이미지<br/>
      > **reference_face_location**: 기준 이미지에서 탐지된 얼굴의 위치 정보<br/>
  ...
  + 얼굴 특징 추출
    ...
    - 함수 : **face_recognition.face_encodings(<탐지할 미디어>, <미디어 내 객체 위치>, <모델>)**<br/>
      <br/>
        > **group_image**: 그룹 이미지, 모자이크 처리 대상 이미지<br/>
        > **group_face_locations**: 그룹 이미지에서 탐지된 얼굴들의 위치 정보<br/>
        > **group_face_encodings**: 그룹 이미지에서 추출된 얼굴들의 특징 인코딩 벡터들 <br/>
  ...
  + 인코딩 벡터 간 유사도 측정
    ...
    - 함수 : **face_recognition.face_distance(<인가 객체 특징 배열>, <모자이크 처리 대상 미디어 특징 배열>)**<br/>
      <br/>
      > **reference_face_encodings**: 기준 이미지에서 추출된 얼굴의 특징 인코딩 벡터<br/>
